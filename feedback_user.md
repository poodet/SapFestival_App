Remarques & retours utilisateurs:

### Retours UX / UI & fonctionnalités (30/01/26)

- Global:
    - ✅ Rendre les elements qui ressemblent a des boutons (activités, bouffe,.. ) cliquable. Soit déployer l'element (activités) soit ouvrir popup
    - Après avoir cliqué sur un évenement ou une personne, pouvoir revenir en arrière en glissant vers la droite
    - homogénéiser les titres (les garder ou les enlever ?)
    - ca manque d'un bouton "accueil" ?
- Info:
    - Rajouter l'onglet info dans la barre de navigation, car bouton crapaud pas clair
    - améliorer le plan du site (pouvoir zoomer)
- Calendrier:
...
- Covoit:
    - ✅ Pouvoir glisser vers le bas le modal d'ajout/edition pour le fermer
    - [FONCTIONNALITE] pouvoir s'inscrire dans une voiture
    - [BUG] bouton "ajouter" non cliquable sur certains téléphone (Juliette, Matras)
    - [FONCTIONNALITE] bouton pour ouvrir whatsapp/sms vers contact
    - ✅ mettre tout en bas les voitures avec 0 place dispo, bien afficher que pas dispo
    - ✅ afficher le mot "disponible" pour clarifier
...
- Autres pages:
    - Lien google drive pour déposer ses photos & vidéos par jour
